...
- **Types**: types should be defined in the file where their primary state is
  defined
...
Millionsweeper is a large-scale minesweeper game using Three.js for efficient
rendering of a 1000x1000 grid. It uses TypeScript, simplex-noise for procedural
generation, and seedrandom for deterministic randomness.

## Tech Overview

Use Three.js InstancedMesh for fast rendering of the grid. But the game is 2d,
always looking down from a top-down perspective.
